...
**Description:**  
URL to redirect the user to after a successful import. This can be used to navigate users to a results page, dashboard, or next step in the workflow after the import process completes successfully.
